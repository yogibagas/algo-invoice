        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                <div class="card-header pb-0 pt-3">
                    <h1 class="card-title text-dark text-center text-capitalize">{{ __('Algo Sea Biz') }}</h1>
                </div>
                <div class="card-body">
                    <p class="text-dark mb-2">Please enter your <strong>username</strong> and <strong>password</strong></p>
