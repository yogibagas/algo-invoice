                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <select class="form-control" name="status" id="input-status">
                          <option value="ONHOLD" {{$model->status == "ONHOLD"? "selected":false}}>ONHOLD</option>
                          ...
                          <div class="card-body">
                            <div class="row">
                              <div class="col-2 col-md-3">
                                <div class="form-group">
                                  <label for="">Item Name*</label>
                                  <input type="text" class="form-control" name="item_name[]" value="{{$model->exists ? $item->item_name : ""}}">
                                </div>
                              </div>
                              <div class="col-2 col-md-2">
                                <div class="form-group">
                              ...
                              <div class="col-2 col-md-1">
                                <div class="form-group">
                                  <label for="">Quantity*</label>
                                  <input type="number" name="item_qty[]" value="{{$model->exists ? $item->qty : 1}}" onkeyup="calcPrice(this)" onload="calcPrice(this)" class="form-control qty">
                                </div>
                              </div>
                              <div class="col-2 col-md-1">
                                <div class="form-group">
                                  <label for="">Item Price*</label>
                                  <input type="number" name="item_price[]" value="{{$model->exists ? $item->price : 0}}" onkeyup="calcPrice(this)" onload="calcPrice(this)" class="form-control price">
                                </div>
                              </div>
                              <div class="col-2 col-md-3">
                                <div class="form-group">
                                  <label for="">Item Note</label>
                                  <input type="text" value="{{$item->item_note}}" name="item_note[]" class="form-control">
                                </div>
                              </div>
                              <div class="col-2 col-md-2">
                                <label>Adjustment/Discount(%)</label>
                                <input type="number" name="item_adjustment[]" value="{{$model->exists ? $item->adjustment/($item->price*$item->qty)*100 : 0 }}" onkeyup="calcPrice(this)" onload="calcPrice(this)" class="form-control adjustment">
                              </div>
                            </div>
                          </div>
