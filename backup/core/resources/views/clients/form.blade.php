            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="col-sm-12">
                  <div class="form-group">
                      <input class="form-control" name="email" id="input-email" type="text" placeholder="Email" value="{{ $client ?  $client->email : old('email') }}" required="true"  required="true" aria-required="true">
                  </div>
                  </div>
                </div>
            </div>
